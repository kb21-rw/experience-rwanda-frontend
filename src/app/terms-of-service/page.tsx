          ...
          <div className="max-w-4xl mx-auto space-y-12">
            <section className="terms-section">
              ...
              <p className=" leading-relaxed">
                ...
                tincidunt. At faucet sapien varius id.
              </p>
            </section>
            <section className="terms-section">
              ...
              <p className=" leading-relaxed mb-4">
                ...
                Suscipit tristique risus, at donec. In turpis sit et quam
                imperdiet. Ipsum molestiae aliquet sodales id est ac volutpat.
              </p>
              <p className=" leading-relaxed">
