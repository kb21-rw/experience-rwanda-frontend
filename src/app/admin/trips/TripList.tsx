      ...
      <div>
        ...
        <div className="flex flex-col md:flex-row gap-5 items-center md:justify-between justify-center py-10">
          <div className="flex items-center gap-10 flex-wrap">
            <TripStatusCard label="Total trips" value={totalTrips || 0} />
            <TripStatusCard label="Booked Trips" value={bookedTrips || 0} />
            <TripStatusCard label="Past Trips" value={pastTrips || 0} />
            <TripStatusCard label="Canceled Trips" value={canceledTrips || 0} />
          </div>
