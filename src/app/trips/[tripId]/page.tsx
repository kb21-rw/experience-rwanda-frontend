    ...
    <section className="min-h-screen bg-site text-gray-125 pt-8 md:pt-12 lg:pt-16">
      <div className="content-wrapper">
        <div className="grid grid-cols-1 md:grid-cols-6 w-full gap-6">
          <div className="h-fit order-2 md:order-none md:col-span-3">
            <TripHero tripDetails={tripDetails} />
          </div>

          <div className="order-1 md:order-none md:col-span-3 overflow-hidden flex flex-col">
            <Image
          ...
          <div className="order-4 md:order-none md:col-span-3h-fit">
            {activities && (
          ...
          <div className="order-3 md:order-none md:col-span-3 bg-site/30 h-fit">
